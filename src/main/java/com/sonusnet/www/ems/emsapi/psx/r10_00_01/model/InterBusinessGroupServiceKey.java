/**
 * InterBusinessGroupServiceKey.java
 *
...
public class InterBusinessGroupServiceKey  extends com.sonusnet.www.ems.emsapi.psx.r10_00_01.model.ManagedEntityKey  implements java.io.Serializable {
    private java.lang.String fromBusinessGroup;

    private java.lang.String toBusinessGroup;

    public InterBusinessGroupServiceKey() {
    }
    ...
    /**
     * Gets the fromBusinessGroup value for this InterBusinessGroupServiceKey.
     * 
    ...
    /**
     * Sets the fromBusinessGroup value for this InterBusinessGroupServiceKey.
     * 
    ...
    /**
     * Gets the toBusinessGroup value for this InterBusinessGroupServiceKey.
     * 
    ...
    /**
     * Sets the toBusinessGroup value for this InterBusinessGroupServiceKey.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InterBusinessGroupServiceKey)) return false;
        InterBusinessGroupServiceKey other = (InterBusinessGroupServiceKey) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InterBusinessGroupServiceKey.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.sonusnet.com/ems/emsapi/psx/r10_00_01/model", "InterBusinessGroupServiceKey"));
