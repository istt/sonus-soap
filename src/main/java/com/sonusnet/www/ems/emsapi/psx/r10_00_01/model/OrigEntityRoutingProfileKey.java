/**
 * OrigEntityRoutingProfileKey.java
 *
...
public class OrigEntityRoutingProfileKey  extends com.sonusnet.www.ems.emsapi.psx.r10_00_01.model.ManagedEntityKey  implements java.io.Serializable {
    private java.lang.String origEntityRoutingProfileId;

    public OrigEntityRoutingProfileKey() {
    }
    ...
    /**
     * Gets the origEntityRoutingProfileId value for this OrigEntityRoutingProfileKey.
     * 
    ...
    /**
     * Sets the origEntityRoutingProfileId value for this OrigEntityRoutingProfileKey.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OrigEntityRoutingProfileKey)) return false;
        OrigEntityRoutingProfileKey other = (OrigEntityRoutingProfileKey) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(OrigEntityRoutingProfileKey.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.sonusnet.com/ems/emsapi/psx/r10_00_01/model", "OrigEntityRoutingProfileKey"));
