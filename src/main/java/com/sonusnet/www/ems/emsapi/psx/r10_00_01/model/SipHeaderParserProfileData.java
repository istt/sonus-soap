/**
 * SipHeaderParserProfileData.java
 *
...
public class SipHeaderParserProfileData  extends com.sonusnet.www.ems.emsapi.psx.r10_00_01.model.ManagedEntityValue  implements java.io.Serializable {
    private java.lang.String sipHeaderParserProfileId;

    private java.lang.Integer sipHeaderEnum;

    public SipHeaderParserProfileData() {
    }
    ...
    /**
     * Gets the sipHeaderParserProfileId value for this SipHeaderParserProfileData.
     * 
    ...
    /**
     * Sets the sipHeaderParserProfileId value for this SipHeaderParserProfileData.
     * 
    ...
    /**
     * Gets the sipHeaderEnum value for this SipHeaderParserProfileData.
     * 
    ...
    /**
     * Sets the sipHeaderEnum value for this SipHeaderParserProfileData.
     * 
     * @param sipHeaderEnum
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SipHeaderParserProfileData)) return false;
        SipHeaderParserProfileData other = (SipHeaderParserProfileData) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SipHeaderParserProfileData.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.sonusnet.com/ems/emsapi/psx/r10_00_01/model", "SipHeaderParserProfileData"));
