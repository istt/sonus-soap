...
public class BusinessLocationKey  extends com.sonusnet.www.ems.emsapi.psx.r10_00_01.model.ManagedEntityKey  implements java.io.Serializable {
    private java.lang.String businessGroupId;

    private java.lang.String businessLocationId;

    public BusinessLocationKey() {
    }
    ...
    /**
     * Gets the businessGroupId value for this BusinessLocationKey.
     * 
    ...
    /**
     * Sets the businessGroupId value for this BusinessLocationKey.
     * 
    ...
    /**
     * Gets the businessLocationId value for this BusinessLocationKey.
     * 
    ...
    /**
     * Sets the businessLocationId value for this BusinessLocationKey.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BusinessLocationKey)) return false;
        BusinessLocationKey other = (BusinessLocationKey) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BusinessLocationKey.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.sonusnet.com/ems/emsapi/psx/r10_00_01/model", "BusinessLocationKey"));
