/**
 * HsxAuthenticationProfileKey.java
 *
...
public class HsxAuthenticationProfileKey  extends com.sonusnet.www.ems.emsapi.psx.r10_00_01.model.ManagedEntityKey  implements java.io.Serializable {
    private java.lang.String authenticationProfileId;

    public HsxAuthenticationProfileKey() {
    }
    ...
    /**
     * Gets the authenticationProfileId value for this HsxAuthenticationProfileKey.
     * 
    ...
    /**
     * Sets the authenticationProfileId value for this HsxAuthenticationProfileKey.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof HsxAuthenticationProfileKey)) return false;
        HsxAuthenticationProfileKey other = (HsxAuthenticationProfileKey) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(HsxAuthenticationProfileKey.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.sonusnet.com/ems/emsapi/psx/r10_00_01/model", "HsxAuthenticationProfileKey"));
